...
export default function MockSlackUI({ children }: PropsWithChildren) {
    return (
        <div className="bg-gray-700 min-h-[800px] rounded-xl max-w-[800px] shadow-2xl relative  w-full overflow-hidden" aria-hidden="true">
                        ...
                        <div className="w-full border border-gray-200 rounded-md">
                            ...
                            <div className="bg-telegram-background  flex items-center rounded-b-md h-14 relative">
                                <input readOnly placeholder="Message # BirdoBot"
                                    className="w-full placeholder:text-gray-500 text-gray-600 focus:outline-none outline-none pt-1.5 pb-8 px-2 text-[12px]" tabIndex={-1} />
