...
export default function MockDiscordUI({ children }: PropsWithChildren) {
    return (
        <div className="bg-gray-600 min-h-[800px] rounded-xl max-w-[800px] shadow-xl relative flex w-full overflow-hidden" aria-hidden="true">
            ...
            <div className="bg-[#2f3136] w-50 hidden lg:flex flex-col">
                ...
                <div className="px-2 ">
                    ...
                    <div className="hover:bg-[#393c43] cursor-not-allowed mt-4 py-2 px-2 flex items-center gap-4">
                        ...
                        />
                        <p className="text-white font-medium">Birdo</p>
                    </div>
            ...
            <div className="w-full flex flex-col flex-1">
                <div className="flex pl-4 bg-[#36393f] w-full h-16 border-[#202225] border-sm items-center border-b">
                    ...
                    <p className="text-white pl-3 font-medium">Birdo</p>
                ...
                <div className="w-full p-4 bg-discord-background">
                    <div className="bg-[#40444b] rounded-lg p-1 flex items-center">
                        ...
                        <input readOnly placeholder="Message @BirdoBot"
                            className="w-full placeholder-discord-timestamp text-white/90 focus:outline-none outline-none py-2.5 px-1 text-sm" tabIndex={-1} />
