...
export default function MockTelegramUI({ children }: PropsWithChildren) {
    return (
        <div className="bg-gray-700 min-h-[800px] rounded-xl  max-w-[800px] shadow-2xl relative flex w-full overflow-hidden" aria-hidden="true">
                ...
                <div className="w-full">
                    <div className="bg-telegram-background  flex items-center">
                        ...
                        <input readOnly placeholder="write a message..."
                            className="w-full placeholder:text-gray-400 text-gray-500 focus:outline-none outline-none py-2.5 px-1 text-sm" tabIndex={-1} />
