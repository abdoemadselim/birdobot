        ...
        <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 px-6 py-4">
            <div className="flex items-center gap-3">
                ...
                <div className="flex justify-between items-center w-full">
                    <div className="flex flex-col">
                        <h2 className="mr-1 text-gray-950 text-lg/7" aria-label={`${category.info.name} category`}>{category.info.emoji || "📂"} {category.info.name}</h2>
            ...
            <div className="flex mt-5 sm:items-center md:lg:items-stretch sm:justify-between md:lg:justify-stretch sm:flex-row  md:lg:flex-col flex-col md:lg:gap-4 sm:gap-0 gap-4 ">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link
                        title="Edit category"
                        href={`/dashboard/category/${category.info.name}/update`}
